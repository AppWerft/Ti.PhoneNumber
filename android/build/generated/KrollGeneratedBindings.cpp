...
namespace titanium {
	namespace bindings {
		...
		BindEntry* PhonenumberBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.phonenumber.PhonenumberModule", ::ti::phoneneumber::PhonenumberModule::bindProxy, ::ti::phoneneumber::PhonenumberModule::dispose}
			};
